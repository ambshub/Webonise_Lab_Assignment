package com.shubham.application.controller;
...
import com.shubham.application.model.User;
import com.shubham.application.repo.UserRepository;
...
public class ApplicationController 
{
	...
	public ModelAndView addUser(@RequestParam("user_email") String user_email, User user)
	{
		...
		List<User> list=userRepo.findByEMAIL(user_email);
